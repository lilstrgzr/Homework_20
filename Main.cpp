...
int main() {
	...
	std::cin >> n;
	std::cout << "Индекс первого вхождения искомого числа - " << search_index(arr, size, n);
	std::cout << std::endl;
	std::cout << "Введите искомое число: ";
	std::cin >> m;
	std::cout << "Индекс последнего вхождения искомого числа - " << search_last_index(arr, size, n);
	std::cout<<std::endl;
	...
	std::cin >> m;
	std::cout << "Элементы в данном диапазоне: ";
	range(arr, size, n, m);
	std::cout << std::endl;
